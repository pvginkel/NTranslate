...
namespace NTranslate.SpellCheck
{
    ...
    {
        private static readonly Padding MultilinePadding = new Padding(3, 1, 3, 1);
        private static readonly Padding SingleLinePadding = new Padding(1, 1, 1, 0);
        ...
        private void UpdateFromMultiline()
        {
            WordWrap = Multiline;
            Padding = Multiline ? MultilinePadding : SingleLinePadding;
        ...
        private void WmNcPaint(ref Message m)
        {
            ...
            if (IsThemeBackgroundPartiallyTransparent(hTheme, EP_EDITTEXT, GetState()) != 0)
            {
